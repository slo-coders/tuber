...
const CourseSelect = props => {
  ...
  return (
    ...
    >
      ...
      />
      <div className='section' style={{paddingLeft:'285px', paddingRight:'285px'}} >
          ...
          <div className='level' >
            {courseList.map(course => {
              return (
                ...
                >
                  <div value={course.id} style={{height:'130px', width:'130px',  padding:'20px',  backgroundColor:'#F5F5F5', boxShadow:'0 2px 3px rgba(10, 10, 10, 0.1), 0 0 0 1px rgba(10, 10, 10, 0.1)'}}>
